...
export async function POST(request: NextRequest) {
  ...
  try {
    const body = await request.json() as { type?: unknown; sessionId?: unknown; source?: unknown; event?: unknown; seconds?: unknown };
    ...
    if (body.type === "view") await recordLandingView(input);
