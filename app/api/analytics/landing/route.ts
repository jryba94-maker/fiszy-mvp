...
export async function POST(request: NextRequest) {
  ...
  try {
    const body = await request.json() as { type?: unknown; sessionId?: unknown; visitorId?: unknown; source?: unknown; event?: unknown; seconds?: unknown };
    ...
    if (body.type === "view") await recordLandingView({ ...input, visitorId: body.visitorId });
