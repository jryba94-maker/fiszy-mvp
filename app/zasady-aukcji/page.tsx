...
export default function Page() { return <LegalPage eyebrow="Mechanika" title="Zasady aukcji" lead="Czytelny opis wejścia, spadającej ceny, zwycięstwa i finalizacji zamówienia." sections={[
  { title: "Przed startem", bullets: ["Każda runda ma własny czas startu, cenę początkową, cenę minimalną i czas trwania.", "Wejście dotyczy jednej konkretnej rundy i nie przechodzi automatycznie na następną.", "Opłata za wejście jest pokazywana przed przejściem do operatora płatności."] },
  { title: "Gdy cena spada", paragraphs: ["Po starcie cena zmienia się według zegara serwera. Zegar urządzenia użytkownika ma charakter informacyjny; rozstrzygający jest stan zapisany po stronie serwera."] },
