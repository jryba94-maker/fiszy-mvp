...
export default function Page() { return <LegalPage eyebrow="Ustawienia przeglądarki" title="Cookies i podobne technologie" lead="Co jest niezbędne do działania konta, a co zależy od zgody." sections={[
  ...
  { title: "Analityka", paragraphs: ["Vercel Web Analytics i Speed Insights mierzą działanie oraz wydajność. Dobrowolna analityka jest używana zgodnie z wyborem użytkownika i właściwymi przepisami dotyczącymi zgody."] },
